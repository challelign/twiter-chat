...
export default function Page() {
  return (
    <div className="h-screen flex items-center justify-between p-8 bg-blue-950">
      <div className="hidden lg:flex w-1/2 items-center justify-center">
        <Image
          src={"/general/logo-transparent.png"}
          alt="Logo"
          width={600}
          height={600}
        />
        ...
        <SignIn.Root>
          ...
          <SignIn.Step name="start">
            <Clerk.Field name="identifier" className="flex flex-col gap-2">
              <Clerk.Input
                placeholder="coderookie@gmail.com"
                className="py-2 px-6 rounded-full text-black w-72 placeholder:text-sm"
              />
              <Clerk.FieldError className="text-red-300 text-sm font-bold" />
          ...
          <SignIn.Step name="reset-password" className="flex flex-col gap-2">
            <h1 className="items-center justify-center text-md font-bold">
              You are reset your password
            </h1>
            <Clerk.Field name="password" className="flex flex-col">
              <Clerk.Label className="font-bold text-md p-1">
                New password
              </Clerk.Label>
              <Clerk.Input
                className="py-2 px-6 rounded-full text-black w-72 placeholder:text-sm   placeholder:text-slate-400"
                placeholder="Provide new password"
              />
              <Clerk.FieldError className="text-red-300 text-sm" />
            </Clerk.Field>

            <Clerk.Field name="confirmPassword" className="flex flex-col">
              <Clerk.Label className="font-bold text-md p-1">
                Confirm password
              </Clerk.Label>
              <Clerk.Input
